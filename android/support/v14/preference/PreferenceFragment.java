...
import android.support.v7.preference.C0383R;
...
public abstract class PreferenceFragment extends Fragment implements OnPreferenceTreeClickListener, OnDisplayPreferenceDialogListener, OnNavigateToScreenListener, TargetFragment {
    ...
    private Handler mHandler = new C01711();
    private boolean mHavePrefs;
    private boolean mInitDone;
    private int mLayoutResId = C0383R.layout.preference_list_fragment;
    private RecyclerView mList;
    private PreferenceManager mPreferenceManager;
    private final Runnable mRequestFocus = new C01722();
    private Runnable mSelectPreferenceRunnable;
    private Context mStyledContext;

    class C01711 extends Handler {
        C01711() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getTheme().resolveAttribute(C0383R.attr.preferenceTheme, tv, true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, C0174R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, C0383R.attr.preferenceFragmentStyle, AndroidResources.ANDROID_R_PREFERENCE_FRAGMENT_STYLE), 0);
        this.mLayoutResId = a.getResourceId(C0174R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(C0174R.styleable.PreferenceFragment_android_divider);
        int dividerHeight = a.getDimensionPixelSize(C0174R.styleable.PreferenceFragment_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(C0174R.styleable.PreferenceFragment_allowDividerAfterLastItem, true);
        a.recycle();
        TypedValue tv = new TypedValue();
        getActivity().getTheme().resolveAttribute(C0383R.attr.preferenceTheme, tv, true);
    ...
    public RecyclerView onCreateRecyclerView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(C0383R.layout.preference_recyclerview, parent, false);
