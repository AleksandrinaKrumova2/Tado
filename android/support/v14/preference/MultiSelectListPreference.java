...
public class MultiSelectListPreference extends AbstractMultiSelectListPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0383R.styleable.MultiSelectListPreference, defStyleAttr, defStyleRes);
        this.mEntries = TypedArrayUtils.getTextArray(a, C0383R.styleable.MultiSelectListPreference_entries, C0383R.styleable.MultiSelectListPreference_android_entries);
        this.mEntryValues = TypedArrayUtils.getTextArray(a, C0383R.styleable.MultiSelectListPreference_entryValues, C0383R.styleable.MultiSelectListPreference_android_entryValues);
        a.recycle();
    }
