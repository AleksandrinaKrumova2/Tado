...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C01271();
    ...
    static class C01271 implements TypeEvaluator<Matrix> {
        C01271() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C01293.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
