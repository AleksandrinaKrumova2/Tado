...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C01491();
    ...
    static class C01491 extends PathMotion {
        C01491() {
        }
    ...
    class C01513 extends AnimatorListenerAdapter {
        C01513() {
        }
    ...
    protected void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues, TransitionValuesMaps endValues, ArrayList<TransitionValues> startValuesList, ArrayList<TransitionValues> endValuesList) {
        ...
        long minStartDelay = LongCompanionObject.MAX_VALUE;
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C01513());
        animator.start();
    }
