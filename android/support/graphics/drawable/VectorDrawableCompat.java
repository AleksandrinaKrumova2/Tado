...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VGroup {
        ...
        private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) {
            ...
            this.mScaleX = TypedArrayUtils.getNamedFloat(a, parser, ToolTipView.SCALE_X_COMPAT, 3, this.mScaleX);
            this.mScaleY = TypedArrayUtils.getNamedFloat(a, parser, ToolTipView.SCALE_Y_COMPAT, 4, this.mScaleY);
    ...
    private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser) throws XmlPullParserException {
        ...
        if (pathRenderer.mViewportWidth <= 0.0f) {
            ...
            if (pathRenderer.mBaseWidth <= 0.0f) {
                ...
                pathRenderer.setAlpha(TypedArrayUtils.getNamedFloat(a, parser, ToolTipView.ALPHA_COMPAT, 4, pathRenderer.getAlpha()));
