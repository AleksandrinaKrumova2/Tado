...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C00921();
        public Bundle menuState;

        static class C00921 implements ClassLoaderCreator<SavedState> {
            C00921() {
            }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0052R.styleable.NavigationView, defStyleAttr, C0052R.style.Widget_Design_NavigationView);
        ...
        this.mMaxWidth = a.getDimensionPixelSize(C0052R.styleable.NavigationView_android_maxWidth, 0);
        ...
        if (a.hasValue(C0052R.styleable.NavigationView_itemTextColor)) {
            itemTextColor = a.getColorStateList(C0052R.styleable.NavigationView_itemTextColor);
        }
        ...
        this.mMenu.setCallback(new C00911());
