...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00792 extends AccessibilityDelegateCompat {
        C00792() {
        }
    ...
    class C00803 implements OnTouchListener {
        C00803() {
        }
    ...
    class C00814 extends BottomSheetCallback {
        C00814() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C00814();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0052R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0052R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0052R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0052R.id.touch_outside).setOnClickListener(new C00781());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C00792());
        bottomSheet.setOnTouchListener(new C00803());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0052R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0052R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
