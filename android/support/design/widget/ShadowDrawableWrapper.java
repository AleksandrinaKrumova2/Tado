...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius, float shadowSize, float maxShadowSize) {
        super(content);
        this.mShadowStartColor = ContextCompat.getColor(context, C0052R.color.design_fab_shadow_start_color);
        this.mShadowMiddleColor = ContextCompat.getColor(context, C0052R.color.design_fab_shadow_mid_color);
        this.mShadowEndColor = ContextCompat.getColor(context, C0052R.color.design_fab_shadow_end_color);
    ...
    private void buildShadowCorners() {
        ...
        this.mCornerShadowPath.arcTo(outerBounds, BitmapDescriptorFactory.HUE_CYAN, 90.0f, false);
        this.mCornerShadowPath.arcTo(innerBounds, BitmapDescriptorFactory.HUE_VIOLET, -90.0f, false);
