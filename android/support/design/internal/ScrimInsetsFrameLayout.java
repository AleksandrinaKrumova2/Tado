...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00581 implements OnApplyWindowInsetsListener {
        C00581() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0052R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0052R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0052R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00581());
    }
