...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attrs) {
        ...
        this.mInactiveItemMaxWidth = res.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = res.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = res.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = res.getDimensionPixelSize(C0052R.dimen.design_bottom_navigation_height);
        ...
        this.mOnClickListener = new C00531();
