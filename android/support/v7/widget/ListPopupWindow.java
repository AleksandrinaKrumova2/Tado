...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C04483 implements OnItemSelectedListener {
        C04483() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0366R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0366R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0366R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0366R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0366R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C04472();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C04483());
