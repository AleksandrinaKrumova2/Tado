...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0366R.attr.actionBarSize, 16842841};
    ...
    class C04091 extends AnimatorListenerAdapter {
        C04091() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT;
        this.mTopAnimatorListener = new C04091();
        this.mRemoveActionBarHideOffset = new C04102();
        this.mAddActionBarHideOffset = new C04113();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0366R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0366R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0366R.id.action_bar));
        }
    }
