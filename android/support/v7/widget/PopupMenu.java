...
public class PopupMenu {
    ...
    class C04521 implements Callback {
        C04521() {
        }
    ...
    class C04532 implements android.widget.PopupWindow.OnDismissListener {
        C04532() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0366R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C04521());
        ...
        this.mPopup.setOnDismissListener(new C04532());
    }
