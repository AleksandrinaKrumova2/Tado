...
import android.support.v7.recyclerview.C0389R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C04573();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04611();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04622();
        private int mWidth;
        ...
        class C04622 implements Callback {
            C04622() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0389R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0389R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0389R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0389R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0389R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C04573 implements Interpolator {
        C04573() {
        }
    ...
    class C04584 implements ProcessCallback {
        C04584() {
        }
    ...
    class C04595 implements Callback {
        C04595() {
        }
    ...
    class C04606 implements Callback {
        C04606() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04631();
        Parcelable mLayoutState;

        static class C04631 implements ClassLoaderCreator<SavedState> {
            C04631() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C04551();
        ...
        this.mItemAnimatorRunner = new C04562();
        this.mViewInfoProcessCallback = new C04584();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0389R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0389R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0389R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0389R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0389R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0389R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0389R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0389R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04595());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04606());
    }
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure && (direction == 2 || direction == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                absDir = direction == 2 ? Constants.DEFAULT_HOT_WATER_TEMPERATURE_FAHRENHEIT : 33;
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0389R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0389R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0389R.dimen.fastscroll_margin));
    }
