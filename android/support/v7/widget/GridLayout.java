...
import android.support.v7.gridlayout.C0367R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0367R.styleable.GridLayout_alignmentMode;
    public static final int ALIGN_BOUNDS = 0;
    public static final int ALIGN_MARGINS = 1;
    public static final Alignment BASELINE = new C04427();
    public static final Alignment BOTTOM = TRAILING;
    static final int CAN_STRETCH = 2;
    public static final Alignment CENTER = new C04406();
    private static final int COLUMN_COUNT = C0367R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0367R.styleable.GridLayout_columnOrderPreserved;
    ...
    public static final Alignment FILL = new C04438();
    public static final int HORIZONTAL = 0;
    static final int INFLEXIBLE = 0;
    private static final Alignment LEADING = new C04373();
    ...
    static final Printer NO_PRINTER = new C04351();
    private static final int ORIENTATION = C0367R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0367R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0367R.styleable.GridLayout_rowOrderPreserved;
    public static final Alignment START = LEADING;
    public static final Alignment TOP = LEADING;
    private static final Alignment TRAILING = new C04384();
    public static final int UNDEFINED = Integer.MIN_VALUE;
    static final Alignment UNDEFINED_ALIGNMENT = new C04362();
    static final int UNINITIALIZED_HASH = 0;
    private static final int USE_DEFAULT_MARGINS = C0367R.styleable.GridLayout_useDefaultMargins;
    ...
    static class C04351 implements Printer {
        C04351() {
        }
    ...
    static class C04362 extends Alignment {
        C04362() {
        }
    ...
    static class C04373 extends Alignment {
        C04373() {
        }
    ...
    static class C04384 extends Alignment {
        C04384() {
        }
    ...
    static class C04406 extends Alignment {
        C04406() {
        }
    ...
    static class C04427 extends Alignment {

        class C04411 extends Bounds {
            private int size;
    ...
    static class C04438 extends Alignment {
        C04438() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0367R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0367R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0367R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0367R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0367R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0367R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0367R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0367R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0367R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0367R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0367R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0367R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attrs) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0367R.styleable.GridLayout_Layout);
            try {
    ...
    public GridLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0367R.dimen.default_gap);
        TypedArray a = context.obtainStyledAttributes(attrs, C0367R.styleable.GridLayout);
        try {
