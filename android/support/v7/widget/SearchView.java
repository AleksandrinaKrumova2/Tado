...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C04673 implements OnFocusChangeListener {
        C04673() {
        }
    ...
    class C04684 implements OnLayoutChangeListener {
        C04684() {
        }
    ...
    class C04695 implements OnClickListener {
        C04695() {
        }
    ...
    class C04706 implements OnKeyListener {
        C04706() {
        }
    ...
    class C04717 implements OnEditorActionListener {
        C04717() {
        }
    ...
    class C04728 implements OnItemClickListener {
        C04728() {
        }
    ...
    class C04739 implements OnItemSelectedListener {
        C04739() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04741();
        boolean isIconified;

        static class C04741 implements ClassLoaderCreator<SavedState> {
            C04741() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0366R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C04751();
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT || (widthDp >= DimensionsKt.XXXHDPI && heightDp >= DimensionsKt.XXHDPI)) {
                return 192;
            }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0366R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C04651();
        this.mReleaseCursorRunnable = new C04662();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C04695();
        this.mTextKeyListener = new C04706();
        this.mOnEditorActionListener = new C04717();
        this.mOnItemClickListener = new C04728();
        this.mOnItemSelectedListener = new C04739();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0366R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0366R.styleable.SearchView_layout, C0366R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0366R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0366R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0366R.id.search_plate);
        this.mSubmitArea = findViewById(C0366R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0366R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0366R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0366R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0366R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0366R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0366R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0366R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0366R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0366R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0366R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0366R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0366R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0366R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0366R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0366R.styleable.SearchView_suggestionRowLayout, C0366R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0366R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C04673());
        setIconifiedByDefault(a.getBoolean(C0366R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0366R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0366R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0366R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0366R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0366R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0366R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C04684());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0366R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0366R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0366R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0366R.dimen.abc_dropdownitem_text_padding_left) : 0;
