...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C04451();
        boolean mAnchorLayoutFromEnd;
        int mAnchorOffset;
        int mAnchorPosition;

        static class C04451 implements Creator<SavedState> {
            C04451() {
            }
    ...
    View findOneVisibleChild(int fromIndex, int toIndex, boolean completelyVisible, boolean acceptPartiallyVisible) {
        ...
        if (completelyVisible) {
            ...
            preferredBoundsFlag = DimensionsKt.XHDPI;
        }
        if (acceptPartiallyVisible) {
            acceptableBoundsFlag = DimensionsKt.XHDPI;
        }
        if (this.mOrientation == 0) {
