...
*/
        ...
        r3 = 0;
        r1 = 0;
        r2 = r7.getTextViewMethod(r9);	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r4 = 0;	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r4 = new java.lang.Object[r4];	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r3 = r2.invoke(r8, r4);	 Catch:{ Exception -> 0x0013, all -> 0x003c }
    ...
    L_0x0013:
        r0 = move-exception;
        r1 = 1;
        r4 = "ACTVAutoSizeHelper";	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r5 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r5.<init>();	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r6 = "Failed to invoke TextView#";	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r5 = r5.append(r6);	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r5 = r5.append(r9);	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r6 = "() method";	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r5 = r5.append(r6);	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        r5 = r5.toString();	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        android.util.Log.w(r4, r5, r0);	 Catch:{ Exception -> 0x0013, all -> 0x003c }
        if (r3 != 0) goto L_0x0012;
    L_0x0038:
        if (r1 == 0) goto L_0x0012;
    L_0x003a:
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(attrs, C0366R.styleable.AppCompatTextView, defStyleAttr, 0);
        if (a.hasValue(C0366R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = a.getInt(C0366R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        if (a.hasValue(C0366R.styleable.AppCompatTextView_autoSizeStepGranularity)) {
            autoSizeStepGranularityInPx = a.getDimension(C0366R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f);
        }
        if (a.hasValue(C0366R.styleable.AppCompatTextView_autoSizeMinTextSize)) {
            autoSizeMinTextSizeInPx = a.getDimension(C0366R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f);
        }
        if (a.hasValue(C0366R.styleable.AppCompatTextView_autoSizeMaxTextSize)) {
            autoSizeMaxTextSizeInPx = a.getDimension(C0366R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f);
        }
        if (a.hasValue(C0366R.styleable.AppCompatTextView_autoSizePresetSizes)) {
            int autoSizeStepSizeArrayResId = a.getResourceId(C0366R.styleable.AppCompatTextView_autoSizePresetSizes, 0);
