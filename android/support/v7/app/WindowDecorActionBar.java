...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03631();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03642();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03653();

    class C03631 extends ViewPropertyAnimatorListenerAdapter {
        C03631() {
        }
    ...
    class C03642 extends ViewPropertyAnimatorListenerAdapter {
        C03642() {
        }
    ...
    class C03653 implements ViewPropertyAnimatorUpdateListener {
        C03653() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0366R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0366R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0366R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0366R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0366R.styleable.ActionBar, C0366R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0366R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0366R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0366R.attr.actionBarWidgetTheme, outValue, true);
