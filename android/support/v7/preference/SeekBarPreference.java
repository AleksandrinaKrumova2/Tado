...
public class SeekBarPreference extends Preference {
    ...
    class C03841 implements OnSeekBarChangeListener {
        C03841() {
        }
    ...
    class C03852 implements OnKeyListener {
        C03852() {
        }
    ...
    private static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C03861();
        int max;
        int min;
        int seekBarValue;

        static class C03861 implements Creator<SavedState> {
            C03861() {
            }
    ...
    public SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSeekBarChangeListener = new C03841();
        this.mSeekBarKeyListener = new C03852();
        TypedArray a = context.obtainStyledAttributes(attrs, C0383R.styleable.SeekBarPreference, defStyleAttr, defStyleRes);
        this.mMin = a.getInt(C0383R.styleable.SeekBarPreference_min, 0);
        setMax(a.getInt(C0383R.styleable.SeekBarPreference_android_max, 100));
        setSeekBarIncrement(a.getInt(C0383R.styleable.SeekBarPreference_seekBarIncrement, 0));
        this.mAdjustable = a.getBoolean(C0383R.styleable.SeekBarPreference_adjustable, true);
        this.mShowSeekBarValue = a.getBoolean(C0383R.styleable.SeekBarPreference_showSeekBarValue, true);
        a.recycle();
    }
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, C0383R.attr.seekBarPreferenceStyle);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        this.mSeekBar = (SeekBar) view.findViewById(C0383R.id.seekbar);
        this.mSeekBarValueTextView = (TextView) view.findViewById(C0383R.id.seekbar_value);
