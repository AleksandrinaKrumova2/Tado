...
public abstract class PreferenceFragmentCompat extends Fragment implements OnPreferenceTreeClickListener, OnDisplayPreferenceDialogListener, OnNavigateToScreenListener, TargetFragment {
    ...
    private Handler mHandler = new C03761();
    private boolean mHavePrefs;
    private boolean mInitDone;
    private int mLayoutResId = C0383R.layout.preference_list_fragment;
    private RecyclerView mList;
    private PreferenceManager mPreferenceManager;
    private final Runnable mRequestFocus = new C03772();
    private Runnable mSelectPreferenceRunnable;
    private Context mStyledContext;

    class C03761 extends Handler {
        C03761() {
        }
    ...
    class C03772 implements Runnable {
        C03772() {
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, C0383R.styleable.PreferenceFragmentCompat, C0383R.attr.preferenceFragmentCompatStyle, 0);
        this.mLayoutResId = a.getResourceId(C0383R.styleable.PreferenceFragmentCompat_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(C0383R.styleable.PreferenceFragmentCompat_android_divider);
        int dividerHeight = a.getDimensionPixelSize(C0383R.styleable.PreferenceFragmentCompat_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(C0383R.styleable.PreferenceFragmentCompat_allowDividerAfterLastItem, true);
        a.recycle();
        TypedValue tv = new TypedValue();
        getActivity().getTheme().resolveAttribute(C0383R.attr.preferenceTheme, tv, true);
