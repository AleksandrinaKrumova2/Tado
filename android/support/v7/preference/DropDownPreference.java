...
public class DropDownPreference extends ListPreference {
    ...
    class C03691 implements OnItemSelectedListener {
        C03691() {
        }
    ...
    public DropDownPreference(Context context, AttributeSet attrs) {
        this(context, attrs, C0383R.attr.dropdownPreferenceStyle);
    }
    ...
    public DropDownPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mItemSelectedListener = new C03691();
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        this.mSpinner = (Spinner) view.itemView.findViewById(C0383R.id.spinner);
