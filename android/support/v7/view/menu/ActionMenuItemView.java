...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0366R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0366R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return widthDp >= DimensionsKt.XXHDPI || ((widthDp >= DimensionsKt.XXXHDPI && config.screenHeightDp >= DimensionsKt.XXHDPI) || config.orientation == 2);
    }
