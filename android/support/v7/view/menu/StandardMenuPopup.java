...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C04062();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C04051();
    ...
    class C04051 implements OnGlobalLayoutListener {
        C04051() {
        }
    ...
    class C04062 implements OnAttachStateChangeListener {
        C04062() {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menu, View anchorView, int popupStyleAttr, int popupStyleRes, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0366R.dimen.abc_config_prefDialogWidth));
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0366R.layout.abc_popup_menu_header_item_layout, listView, false);
