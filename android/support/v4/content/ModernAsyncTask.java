...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C02091();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02102();

    static class C02091 implements ThreadFactory {
    ...
    class C02102 extends WorkerRunnable<Params, Result> {
        C02102() {
        }
