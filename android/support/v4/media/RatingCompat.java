...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C02601();
    ...
    static class C02601 implements Creator<RatingCompat> {
        C02601() {
        }
    ...
    public static RatingCompat fromRating(Object ratingObj) {
        ...
        if (ratingObj != null && VERSION.SDK_INT >= 19) {
            ...
            if (((Rating) ratingObj).isRated()) {
                switch (ratingStyle) {
                    case 1:
                        ratingCompat = newHeartRating(((Rating) ratingObj).hasHeart());
                        break;
                    case 2:
                        ratingCompat = newThumbRating(((Rating) ratingObj).isThumbUp());
                        break;
                    case 3:
                    case 4:
                    case 5:
                        ratingCompat = newStarRating(ratingStyle, ((Rating) ratingObj).getStarRating());
                        break;
                    case 6:
                        ratingCompat = newPercentageRating(((Rating) ratingObj).getPercentRating());
                        break;
                }
            }
