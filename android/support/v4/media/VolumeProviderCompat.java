...
public abstract class VolumeProviderCompat {
    ...
    class C02611 implements Delegate {
        C02611() {
        }
    ...
    public Object getVolumeProvider() {
        if (this.mVolumeProviderObj == null && VERSION.SDK_INT >= 21) {
            this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new C02611());
        }
