...
import android.support.mediacompat.C0113R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0113R.id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0113R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0113R.id.end_padder, 8);
                view.setViewVisibility(C0113R.id.cancel_action, 0);
                view.setOnClickPendingIntent(C0113R.id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0113R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0113R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0113R.id.end_padder, 0);
                view.setViewVisibility(C0113R.id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0113R.layout.notification_media_action);
            button.setImageViewResource(C0113R.id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0113R.id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0113R.id.action0, action.getTitle());
            }
            return button;
        }

        int getContentViewLayoutResource() {
            return C0113R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0113R.id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0113R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                big.setViewVisibility(C0113R.id.cancel_action, 0);
                big.setInt(C0113R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0113R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0113R.id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0113R.id.cancel_action, 8);
            }
            return big;
        }

        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0113R.layout.notification_template_big_media_narrow : C0113R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0113R.layout.notification_template_media_custom;
            }
        ...
        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0113R.layout.notification_template_big_media_narrow_custom : C0113R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0113R.color.notification_material_background_media_default_color);
            }
            views.setInt(C0113R.id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
