...
public class MediaSessionCompat {
    ...
    class C02631 extends Callback {
        C02631() {
        }
    }

    class C02642 extends Callback {
        C02642() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02671();
        VolumeProviderCompat mVolumeProvider;
        int mVolumeType;

        class C02671 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02671() {
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C02651 implements OnPlaybackPositionUpdateListener {
            C02651() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C02651());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C02661 implements OnMetadataUpdateListener {
            C02661() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C02661());
        }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C02681();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C02681 implements Creator<QueueItem> {
            C02681() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C02691();
        private ResultReceiver mResultReceiver;

        static class C02691 implements Creator<ResultReceiverWrapper> {
            C02691() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C02701();
        private final IMediaSession mExtraBinder;
        private final Object mInner;

        static class C02701 implements Creator<Token> {
            C02701() {
            }
