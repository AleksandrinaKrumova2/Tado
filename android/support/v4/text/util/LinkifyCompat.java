...
public final class LinkifyCompat {
    private static final Comparator<LinkSpec> COMPARATOR = new C03001();
    private static final String[] EMPTY_STRING = new String[0];

    static class C03001 implements Comparator<LinkSpec> {
        C03001() {
        }
        ...
        while (true) {
            ...
            if (address != null) {
                ...
                if (start >= 0) {
                    ...
                    try {
                        spec.url = "geo:0,0?q=" + URLEncoder.encode(address, HttpRequest.CHARSET_UTF8);
                        links.add(spec);
