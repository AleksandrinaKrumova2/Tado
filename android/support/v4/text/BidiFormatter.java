...
public final class BidiFormatter {
    ...
    private static class DirectionalityEstimator {
        ...
        byte dirTypeForward() {
            ...
            if (this.lastChar == Typography.less) {
                return skipTagForward();
            }
            if (this.lastChar == Typography.amp) {
        ...
        byte dirTypeBackward() {
            ...
            if (this.lastChar == Typography.greater) {
        ...
        private byte skipTagForward() {
            ...
            while (this.charIndex < this.length) {
                ...
                if (this.lastChar == Typography.quote || this.lastChar == '\'') {
        ...
        private byte skipTagBackward() {
            ...
            while (this.charIndex > 0) {
                ...
                if (this.lastChar == Typography.greater) {
                    break;
                } else if (this.lastChar == Typography.quote || this.lastChar == '\'') {
                    char quote = this.lastChar;
                    while (this.charIndex > 0) {
                        charSequence = this.text;
                        i = this.charIndex - 1;
