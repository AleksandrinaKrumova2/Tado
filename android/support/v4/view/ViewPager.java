...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C03121();
    ...
    private static final Interpolator sInterpolator = new C03132();
    ...
    private final Runnable mEndScrollRunnable = new C03143();
    ...
    static class C03121 implements Comparator<ItemInfo> {
        C03121() {
        }
    ...
    static class C03132 implements Interpolator {
        C03132() {
        }
    ...
    class C03154 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03161 implements ClassLoaderCreator<SavedState> {
            C03161() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03154());
    }
