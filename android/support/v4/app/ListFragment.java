...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C02072();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C02061();
    ...
    class C02072 implements OnItemClickListener {
        C02072() {
        }
