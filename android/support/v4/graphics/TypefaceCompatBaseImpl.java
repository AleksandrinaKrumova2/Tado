...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C02171 implements StyleExtractor<FontInfo> {
        C02171() {
        }
    ...
    class C02182 implements StyleExtractor<FontFileResourceEntry> {
        C02182() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C02171());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C02182());
    }
