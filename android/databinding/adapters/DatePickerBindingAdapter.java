...
import com.android.databinding.library.baseAdapters.C0503R;
...
public class DatePickerBindingAdapter {
    ...
    public static void setListeners(DatePicker view, int year, int month, int day, OnDateChangedListener listener, InverseBindingListener yearChanged, InverseBindingListener monthChanged, InverseBindingListener dayChanged) {
        ...
        DateChangedListener oldListener = (DateChangedListener) ListenerUtil.getListener(view, C0503R.id.onDateChanged);
        if (oldListener == null) {
            oldListener = new DateChangedListener();
            ListenerUtil.trackListener(view, oldListener, C0503R.id.onDateChanged);
        }
