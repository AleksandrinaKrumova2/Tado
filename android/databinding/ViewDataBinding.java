...
import com.android.databinding.library.C0502R;
...
public abstract class ViewDataBinding extends BaseObservable {
    ...
    private static final CreateWeakListener CREATE_LIST_LISTENER = new C00172();
    private static final CreateWeakListener CREATE_MAP_LISTENER = new C00183();
    private static final CreateWeakListener CREATE_PROPERTY_LISTENER = new C00161();
    private static final int HALTED = 2;
    private static final int REBIND = 1;
    private static final NotifierCallback<OnRebindCallback, ViewDataBinding, Void> REBIND_NOTIFIER = new C00194();
    ...
    private final Runnable mRebindRunnable = new C00216();
    ...
    static class C00161 implements CreateWeakListener {
        C00161() {
        }
    ...
    static class C00172 implements CreateWeakListener {
        C00172() {
        }
    ...
    static class C00183 implements CreateWeakListener {
        C00183() {
        }
    ...
    static class C00194 extends NotifierCallback<OnRebindCallback, ViewDataBinding, Void> {
        C00194() {
        }
    ...
    static class C00205 implements OnAttachStateChangeListener {
        C00205() {
        }
    ...
    class C00216 implements Runnable {
        C00216() {
        }
    ...
    class C00227 implements FrameCallback {
        C00227() {
        }
    ...
    static {
        ...
        if (VERSION.SDK_INT < 19) {
            ...
            ROOT_REATTACHED_LISTENER = new C00205();
        }
    }
    ...
    protected ViewDataBinding(DataBindingComponent bindingComponent, View root, int localFieldCount) {
        ...
        if (Looper.myLooper() == null) {
            ...
            this.mFrameCallback = new C00227();
        } else {
    ...
    protected void setRootTag(View view) {
        if (USE_TAG_ID) {
            view.setTag(C0502R.id.dataBinding, this);
        } else {
            view.setTag(this);
        }
    }
    ...
    protected void setRootTag(View[] views) {
        ...
        if (USE_TAG_ID) {
            length = views.length;
            while (i < length) {
                views[i].setTag(C0502R.id.dataBinding, this);
                i++;
            }
            return;
        }
    ...
    static ViewDataBinding getBinding(View v) {
        if (v != null) {
            if (USE_TAG_ID) {
                return (ViewDataBinding) v.getTag(C0502R.id.dataBinding);
            }
            Object tag = v.getTag();
