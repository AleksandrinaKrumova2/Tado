...
public final class ViewChildrenSequencesKt {
    public static final void forEachChild(@NotNull ViewGroup $receiver, @NotNull Function1<? super View, Unit> action) {
    ...
    public static final void forEachChildWithIndex(@NotNull ViewGroup $receiver, @NotNull Function2<? super Integer, ? super View, Unit> action) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(action, "action");
        int i = 0;
        int childCount = $receiver.getChildCount() - 1;
    ...
    @NotNull
    public static final View firstChild(@NotNull ViewGroup $receiver, @NotNull Function1<? super View, Boolean> predicate) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
    ...
    @Nullable
    public static final View firstChildOrNull(@NotNull ViewGroup $receiver, @NotNull Function1<? super View, Boolean> predicate) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(predicate, "predicate");
        int i = 0;
        int childCount = $receiver.getChildCount() - 1;
    ...
    @NotNull
    public static final Sequence<View> childrenSequence(@NotNull View $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        return new ViewChildrenSequence($receiver);
    }

    @NotNull
    public static final Sequence<View> childrenRecursiveSequence(@NotNull View $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
