...
public interface AnkoContext<T> extends ViewManager {
    ...
    public static final class DefaultImpls {
        public static <T> void updateViewLayout(@NotNull AnkoContext<? extends T> $this, @NotNull View view, LayoutParams params) {
            Intrinsics.checkParameterIsNotNull(view, Promotion.ACTION_VIEW);
            Intrinsics.checkParameterIsNotNull(params, "params");
            throw new UnsupportedOperationException();
        }

        public static <T> void removeView(@NotNull AnkoContext<? extends T> $this, View view) {
            Intrinsics.checkParameterIsNotNull(view, Promotion.ACTION_VIEW);
            throw new UnsupportedOperationException();
        }
    }
