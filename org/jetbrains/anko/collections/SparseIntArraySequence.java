...
public final class SparseIntArraySequence implements Sequence<Integer> {
    private final SparseIntArray f423a;
    ...
    private final class SparseIntArrayIterator implements Iterator<Integer>, KMappedMarker {
        ...
        public SparseIntArrayIterator() {
            this.size = SparseIntArraySequence.this.f423a.size();
        }
        ...
        @NotNull
        public Integer next() {
            if (SparseIntArraySequence.this.f423a.size() != this.size) {
                throw new ConcurrentModificationException();
            }
            SparseIntArray access$getA$p = SparseIntArraySequence.this.f423a;
            int i = this.index;
            this.index = i + 1;
