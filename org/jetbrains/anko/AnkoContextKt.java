...
public final class AnkoContextKt {
    @NotNull
    public static final AnkoContext<Context> UI(@NotNull Context $receiver, boolean setContentView, @NotNull Function1<? super AnkoContext<? extends Context>, Unit> init) {
    ...
    @NotNull
    public static final AnkoContext<Context> UI(@NotNull Context $receiver, @NotNull Function1<? super AnkoContext<? extends Context>, Unit> init) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(init, "init");
        AnkoInternals ankoInternals = AnkoInternals.INSTANCE;
    ...
    @NotNull
    public static final AnkoContext<Fragment> UI(@NotNull Fragment $receiver, @NotNull Function1<? super AnkoContext<? extends Fragment>, Unit> init) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(init, "init");
        AnkoInternals ankoInternals = AnkoInternals.INSTANCE;
        Activity activity = $receiver.getActivity();
        Intrinsics.checkExpressionValueIsNotNull(activity, "activity");
        AnkoContextImpl dsl$iv = new AnkoContextImpl(activity, $receiver, false);
        init.invoke(dsl$iv);
        return dsl$iv;
    }
