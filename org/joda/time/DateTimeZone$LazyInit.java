...
final class DateTimeZone$LazyInit {
    ...
    static class C13971 extends BaseChronology {
    ...
    private static DateTimeFormatter buildFormatter() {
        return new DateTimeFormatterBuilder().appendTimeZoneOffset(null, true, 2, 4).toFormatter().withChronology(new C13971());
    }
