...
public class CircleIndicator extends LinearLayout {
    ...
    private DataSetObserver mInternalDataSetObserver = new 2(this);
    private final OnPageChangeListener mInternalPageChangeListener = new 1(this);
    ...
    private Animator createAnimatorIn(Context context) {
        ...
        animatorIn.setInterpolator(new ReverseInterpolator(this, null));
        return animatorIn;
    }
