...
public class DatePickerDialog extends DialogFragment implements OnClickListener, DatePickerController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(this.mVersion == Version.VERSION_1 ? R.layout.mdtp_date_picker_dialog : R.layout.mdtp_date_picker_dialog_v2, container, false);
        this.mCalendar = this.mDateRangeLimiter.setToNearestDate(this.mCalendar);
        this.mDatePickerHeaderView = (TextView) view.findViewById(R.id.mdtp_date_picker_header);
        this.mMonthAndDayView = (LinearLayout) view.findViewById(R.id.mdtp_date_picker_month_and_day);
        this.mMonthAndDayView.setOnClickListener(this);
        this.mSelectedMonthTextView = (TextView) view.findViewById(R.id.mdtp_date_picker_month);
        this.mSelectedDayTextView = (TextView) view.findViewById(R.id.mdtp_date_picker_day);
        this.mYearView = (TextView) view.findViewById(R.id.mdtp_date_picker_year);
        ...
        view.setBackgroundColor(ContextCompat.getColor(activity, this.mThemeDark ? R.color.mdtp_date_picker_view_animator_dark_theme : R.color.mdtp_date_picker_view_animator));
        this.mAnimator = (AccessibleDateAnimator) view.findViewById(R.id.mdtp_animator);
        ...
        okButton.setOnClickListener(new C13141());
        ...
        cancelButton.setOnClickListener(new C13152());
        ...
        view.findViewById(R.id.mdtp_day_picker_selected_date_layout).setBackgroundColor(this.mAccentColor);
        if (this.mOkColor != -1) {
