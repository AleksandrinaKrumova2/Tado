...
public class RadialTextsView extends View {
    ...
    public void initialize(Context context, String[] texts, String[] innerTexts, TimePickerController controller, SelectionValidator validator, boolean disappearsOut) {
        ...
        this.mPaint.setColor(ContextCompat.getColor(context, controller.isThemeDark() ? R.color.mdtp_white : R.color.mdtp_numbers_text_color));
        this.mTypefaceLight = Typeface.create(res.getString(R.string.mdtp_radial_numbers_typeface), 0);
        ...
        this.mInactivePaint.setColor(ContextCompat.getColor(context, controller.isThemeDark() ? R.color.mdtp_date_picker_text_disabled_dark_theme : R.color.mdtp_date_picker_text_disabled));
        ...
        if (this.mHasInnerCircle) {
            ...
            if (controller.getVersion() == TimePickerDialog$Version.VERSION_1) {
                ...
                this.mTextSizeMultiplier = Float.parseFloat(res.getString(R.string.mdtp_text_size_multiplier_outer_v2));
                this.mInnerTextSizeMultiplier = Float.parseFloat(res.getString(R.string.mdtp_text_size_multiplier_inner_v2));
            }
    ...
    private void renderAnimations() {
        ...
        PropertyValuesHolder fadeOut = PropertyValuesHolder.ofKeyframe(ToolTipView.ALPHA_COMPAT, new Keyframe[]{kf0, kf1});
        ...
        PropertyValuesHolder fadeIn = PropertyValuesHolder.ofKeyframe(ToolTipView.ALPHA_COMPAT, new Keyframe[]{kf0, kf1, kf2});
