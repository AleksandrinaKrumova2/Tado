...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    class C13201 implements SelectionValidator {
        C13201() {
        }
    ...
    class C13212 implements SelectionValidator {
        C13212() {
        }
    ...
    class C13223 implements SelectionValidator {
        C13223() {
        }
    ...
    class C13234 implements Runnable {
        C13234() {
        }
    ...
    public void initialize(Context context, TimePickerController timePickerController, Timepoint initialTime, boolean is24HourMode) {
        ...
        SelectionValidator c13201 = new C13201();
        SelectionValidator minuteValidator = new C13212();
        SelectionValidator hourValidator = new C13223();
        int[] iArr = new int[12];
        ...
        this.mSecondRadialTextsView.initialize(context, secondsTexts, null, this.mController, c13201, false);
    ...
    private Timepoint getTimeFromDegrees(int degrees, boolean isInnerCircle, boolean forceToVisibleValue) {
        ...
        if (currentShowing == 0 && this.mController.getVersion() != TimePickerDialog$Version.VERSION_1 && this.mIs24HourMode) {
            value = (value + 12) % 24;
        }
        switch (currentShowing) {
            case 0:
        ...
        switch (event.getAction()) {
            case 0:
                ...
                if (this.mIsTouchingAmOrPm == 0 || this.mIsTouchingAmOrPm == 1) {
                    ...
                    this.mDownDegrees = -1;
                    this.mHandler.postDelayed(new C13234(), (long) this.TAP_TIMEOUT);
                } else {
