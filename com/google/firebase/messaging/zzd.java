...
final class zzd {
    private static void zzb(Context context, String str, Intent intent) {
        ...
        if (zzdc != null) {
            zzdc.logEventInternal(AppMeasurement.FCM_ORIGIN, str, bundle);
        } else {
    ...
    public static void zzg(Context context, Intent intent) {
        if (intent != null) {
            if ("1".equals(intent.getStringExtra("google.c.a.tc"))) {
                ...
                if (zzdc != null) {
                    String stringExtra = intent.getStringExtra("google.c.a.c_id");
                    zzdc.setUserPropertyInternal(AppMeasurement.FCM_ORIGIN, UserProperty.FIREBASE_LAST_NOTIFICATION, stringExtra);
                    Bundle bundle = new Bundle();
                    ...
                    zzdc.logEventInternal(AppMeasurement.FCM_ORIGIN, "_cmp", bundle);
                } else {
