...
final class zzax extends SQLiteOpenHelper {
    ...
    zzax(zzat com_google_android_gms_tagmanager_zzat, Context context, String str) {
    ...
    public final SQLiteDatabase getWritableDatabase() {
        ...
        try {
            ...
            this.zzkfa.mContext.getDatabasePath("google_tagmanager.db").delete();
        }
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        if (zza("datalayer", sQLiteDatabase)) {
            ...
            try {
                ...
                if (!hashSet.remove(OnboardingPageFragment.FEATURE_KEY) || !hashSet.remove(Param.VALUE) || !hashSet.remove("ID") || !hashSet.remove("expires")) {
            ...
            sQLiteDatabase.execSQL(zzat.zzkeu);
        }
    }
