    ...
    public final void onActivityCreated(Activity activity, Bundle bundle) {
            ...
            if (intent != null) {
                ...
                if (data != null && data.isHierarchical()) {
                    if (bundle == null) {
                        ...
                        this.zzjhc.zzawu();
                        String str = zzclq.zzo(intent) ? "gs" : CapabilitiesController.AUTO;
                        if (zzp != null) {
                    ...
                    if (!TextUtils.isEmpty(queryParameter)) {
                        ...
                        if (!TextUtils.isEmpty(queryParameter)) {
                            this.zzjhc.zzb(CapabilitiesController.AUTO, "_ldl", queryParameter);
                        }
                    } else {
                        return;
                    }
        ...
        if (bundle != null) {
            ...
            if (bundle2 != null) {
                ...
                zzq.zziwm = bundle2.getLong(ToolTipRelativeLayout.ID);
                zzq.zziwk = bundle2.getString(CreateHomeContactDetailsActivity.INTENT_NAME);
