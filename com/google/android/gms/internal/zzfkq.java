...
public final class zzfkq extends zzfjm<zzfkq> implements Cloneable {
    ...
    public zzfkq() {
        ...
        this.zzpqv = null;
        this.zzpqw = "";
        this.zzpqx = Constants.WAIT_FOR_COMMANDSET_UPDATE_TIMEOUT;
        this.zzpqy = null;
    ...
    L_0x00e6:
        r2 = r8.getPosition();
        r3 = r8.zzcvw();	 Catch:{ IllegalArgumentException -> 0x010d }
        switch(r3) {
    ...
    public final void zza(zzfjk com_google_android_gms_internal_zzfjk) throws IOException {
        ...
        if (this.zzpqx != Constants.WAIT_FOR_COMMANDSET_UPDATE_TIMEOUT) {
