    ...
    public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (com_google_android_gms_internal_zzckf != null) {
                ...
                bundle2.putLong(ToolTipRelativeLayout.ID, com_google_android_gms_internal_zzckf.zziwm);
                bundle2.putString(CreateHomeContactDetailsActivity.INTENT_NAME, com_google_android_gms_internal_zzckf.zziwk);
