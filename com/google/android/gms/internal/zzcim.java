...
public class zzcim {
    ...
    private final long zzbag() {
        ...
        if (j == 0) {
            j = 1 + ((long) zzawz.zzawu().zzbaz().nextInt(DateTimeConstants.MILLIS_PER_DAY));
            zzawz.zzjcv.set(j);
        }
                ...
                if (zzawm.zziwf.zzazv()) {
                    ...
                    if (!TextUtils.isEmpty(zzazq)) {
                        ...
                        if (!zzazq.equals(VERSION.RELEASE)) {
                            ...
                            zzawm.zzc(CapabilitiesController.AUTO, "_ou", bundle);
                        }
                    }
                }
            ...
            if (com_google_android_gms_internal_zzcgi.zzixx) {
                ...
                if (zzjb != null) {
                    if (!(zzjb.zzvj() == null || zzjb.zzvj().equals(com_google_android_gms_internal_zzcgi.zzifm))) {
                        ...
                        zzb(new zzcha("_au", new zzcgx(bundle), CapabilitiesController.AUTO, j), com_google_android_gms_internal_zzcgi);
                    }
                }
                zzg(com_google_android_gms_internal_zzcgi);
                ...
                if (com_google_android_gms_internal_zzcgw == null) {
                    ...
                    if (i == 0) {
                        zzb(new zzcln("_fot", j, Long.valueOf(j2), CapabilitiesController.AUTO), com_google_android_gms_internal_zzcgi);
                        zzawx().zzve();
                        zzxf();
                        ...
                        if (this.mContext.getPackageManager() == null) {
                            ...
                            if (packageInfo != null) {
                                if (packageInfo.firstInstallTime != 0) {
                                    ...
                                    zzb(new zzcln("_fi", j, Long.valueOf(obj != null ? 1 : 0), CapabilitiesController.AUTO), com_google_android_gms_internal_zzcgi);
                                }
                            }
                            try {
                        ...
                        zzb(new zzcha("_f", new zzcgx(bundle2), CapabilitiesController.AUTO, j), com_google_android_gms_internal_zzcgi);
                    } else if (i == 1) {
                        zzb(new zzcln("_fvt", j, Long.valueOf(j2), CapabilitiesController.AUTO), com_google_android_gms_internal_zzcgi);
                        zzawx().zzve();
                        zzxf();
                        bundle = new Bundle();
                        bundle.putLong("_c", 1);
                        bundle.putLong("_r", 1);
                        zzb(new zzcha("_v", new zzcgx(bundle), CapabilitiesController.AUTO, j), com_google_android_gms_internal_zzcgi);
                    }
                    bundle = new Bundle();
                    bundle.putLong("_et", 1);
                    zzb(new zzcha("_e", new zzcgx(bundle), CapabilitiesController.AUTO, j), com_google_android_gms_internal_zzcgi);
                } else if (com_google_android_gms_internal_zzcgi.zzixy) {
                    zzb(new zzcha("_cd", new zzcgx(new Bundle()), CapabilitiesController.AUTO, j), com_google_android_gms_internal_zzcgi);
                }
                zzaws().setTransactionSuccessful();
                zzaws().endTransaction();
                return;
