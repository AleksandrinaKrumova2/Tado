...
public final class zzchc {
    ...
    public static zzchd<Long> zzjae = zzchd.zzb("measurement.ad_id_cache_time", (long) Constants.WIFI_CONNECTION_RETRY_TIMEOUT, (long) Constants.WIFI_CONNECTION_RETRY_TIMEOUT);
    ...
    public static zzchd<Integer> zzjak = zzchd.zzm("measurement.upload.max_batch_size", 65536, 65536);
    public static zzchd<Integer> zzjal = zzchd.zzm("measurement.upload.max_bundle_size", 65536, 65536);
    public static zzchd<Integer> zzjam = zzchd.zzm("measurement.upload.max_events_per_bundle", 1000, 1000);
    public static zzchd<Integer> zzjan = zzchd.zzm("measurement.upload.max_events_per_day", 100000, 100000);
    ...
    public static zzchd<Integer> zzjas = zzchd.zzm("measurement.store.max_stored_events_per_app", 100000, 100000);
    ...
    public static zzchd<Long> zzjax = zzchd.zzb("measurement.upload.realtime_upload_interval", (long) Constants.WIFI_CONNECTION_RETRY_TIMEOUT, (long) Constants.WIFI_CONNECTION_RETRY_TIMEOUT);
    ...
    public static zzchd<Long> zzjba = zzchd.zzb("measurement.alarm_manager.minimum_interval", 60000, 60000);
    ...
    public static zzchd<Long> zzjbj = zzchd.zzb("measurement.service_client.idle_disconnect_millis", (long) Constants.CHECK_FOR_SERVER_CONNECTION_TIMEOUT, (long) Constants.CHECK_FOR_SERVER_CONNECTION_TIMEOUT);
