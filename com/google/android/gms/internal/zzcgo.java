...
final class zzcgo extends zzcjl {
    ...
    private final boolean zze(String str, List<Integer> list) {
        ...
        try {
            if (zzb("select count(1) from audience_filter_values where app_id=?", new String[]{str}) <= ((long) Math.max(0, Math.min(MorphingButton.COLLAPSE_ANIMATION_DELAY, zzaxa().zzb(str, zzchc.zzjbi))))) {
                return false;
            }
    ...
    public final void zza(zzcgw com_google_android_gms_internal_zzcgw) {
        ...
        contentValues.put(CreateHomeContactDetailsActivity.INTENT_NAME, com_google_android_gms_internal_zzcgw.mName);
    ...
    public final boolean zza(zzcgl com_google_android_gms_internal_zzcgl) {
        ...
        contentValues.put(CreateHomeContactDetailsActivity.INTENT_NAME, com_google_android_gms_internal_zzcgl.zziyg.name);
    ...
    public final boolean zza(zzcgv com_google_android_gms_internal_zzcgv, long j, boolean z) {
        ...
        try {
            ...
            contentValues.put(CreateHomeContactDetailsActivity.INTENT_NAME, com_google_android_gms_internal_zzcgv.mName);
    ...
    public final boolean zza(zzclp com_google_android_gms_internal_zzclp) {
        ...
        contentValues.put(CreateHomeContactDetailsActivity.INTENT_NAME, com_google_android_gms_internal_zzclp.mName);
    ...
    public final List<zzcgl> zzc(String str, String[] strArr) {
        ...
        try {
            query = getWritableDatabase().query("conditional_properties", new String[]{"app_id", Param.ORIGIN, CreateHomeContactDetailsActivity.INTENT_NAME, Param.VALUE, "active", "trigger_event_name", "trigger_timeout", "timed_out_event", "creation_timestamp", "triggered_event", "triggered_timestamp", "time_to_live", "expired_event"}, str, strArr, null, null, "rowid", "1001");
            try {
                if (query.moveToFirst()) {
                    do {
    ...
    public final List<zzclp> zzg(String str, String str2, String str3) {
        ...
        try {
            ...
            String[] strArr = new String[]{CreateHomeContactDetailsActivity.INTENT_NAME, "set_timestamp", Param.VALUE, Param.ORIGIN};
    ...
    public final List<zzclp> zzja(String str) {
        ...
        List<zzclp> arrayList = new ArrayList();
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{CreateHomeContactDetailsActivity.INTENT_NAME, Param.ORIGIN, "set_timestamp", Param.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", "1000");
            try {
                if (query.moveToFirst()) {
                    do {
                        String string = query.getString(0);
