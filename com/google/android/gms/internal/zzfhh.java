...
final class zzfhh {
    ...
    static final void zzb(StringBuilder stringBuilder, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            stringBuilder.append(": \"").append(zzfih.zzbc(zzfes.zztr((String) obj))).append(Typography.quote);
        } else if (obj instanceof zzfes) {
            stringBuilder.append(": \"").append(zzfih.zzbc((zzfes) obj)).append(Typography.quote);
