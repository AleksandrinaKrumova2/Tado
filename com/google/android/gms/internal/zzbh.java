...
public enum zzbh {
    ...
    COUNTRY(CreateHomeContactDetailsActivity.INTENT_COUNTRY),
    CSS_ID("css_id"),
    ...
    MIN("min"),
    MODE("mode"),
    NAME(CreateHomeContactDetailsActivity.INTENT_NAME),
    ...
    PAGE(PromoPageFragment.ARG_PAGE),
    PAGE_PATH("page_path"),
    PARAMS("params"),
    PARTITION("partition"),
