...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zzflr = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0565R.styleable.SignInButton, 0, 0);
        try {
            this.mSize = obtainStyledAttributes.getInt(C0565R.styleable.SignInButton_buttonSize, 0);
            this.mColor = obtainStyledAttributes.getInt(C0565R.styleable.SignInButton_colorScheme, 2);
