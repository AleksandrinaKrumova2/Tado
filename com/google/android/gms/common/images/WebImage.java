...
public final class WebImage extends zzbfm {
    ...
    public WebImage(JSONObject jSONObject) throws IllegalArgumentException {
        this(zzy(jSONObject), jSONObject.optInt(SettingsJsonConstants.ICON_WIDTH_KEY, 0), jSONObject.optInt(SettingsJsonConstants.ICON_HEIGHT_KEY, 0));
    }
    ...
    public final JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.put(SettingsJsonConstants.ICON_WIDTH_KEY, this.zzalv);
            jSONObject.put(SettingsJsonConstants.ICON_HEIGHT_KEY, this.zzalw);
        } catch (JSONException e) {
        }
        return jSONObject;
    }
