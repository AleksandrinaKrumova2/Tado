...
public final class ConnectionResult extends zzbfm {
    ...
    public final String toString() {
        return zzbg.zzx(this).zzg("statusCode", getStatusString(this.zzcd)).zzg("resolution", this.zzeeo).zzg(SettingsJsonConstants.PROMPT_MESSAGE_KEY, this.zzfks).toString();
    }
