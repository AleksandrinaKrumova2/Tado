...
final class zzai extends zzag implements Callback {
    ...
    zzai(Context context) {
        ...
        this.zzgao = Constants.CHECK_FOR_SERVER_CONNECTION_TIMEOUT;
        this.zzgap = Constants.WAIT_FOR_FIRMWARE_UPDATE_TIMEOUT;
    }
            ...
            case 1:
                synchronized (this.zzgam) {
                    ...
                    if (com_google_android_gms_common_internal_zzaj != null && com_google_android_gms_common_internal_zzaj.getState() == 3) {
                        ...
                        com_google_android_gms_common_internal_zzaj.onServiceDisconnected(componentName == null ? new ComponentName(com_google_android_gms_common_internal_zzah.getPackage(), EnvironmentCompat.MEDIA_UNKNOWN) : componentName);
                    }
                }
                return true;
            default:
