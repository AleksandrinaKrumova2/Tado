...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06221();
    ...
    static class C06221 implements Comparator<Comparable> {
        C06221() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C06231 extends LinkedTreeMapIterator<Entry<K, V>> {
            C06231() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C06241 extends LinkedTreeMapIterator<K> {
            C06241() {
                super();
            }
