...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C06191();
    ...
    static class C06191 implements Comparator<Comparable> {
        C06191() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C06201 extends LinkedTreeMapIterator<Entry<K, V>> {
            C06201() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C06211 extends LinkedTreeMapIterator<K> {
            C06211() {
                super();
            }
