...
class CrashlyticsController {
    ...
    static final Comparator<File> LARGEST_FILE_NAME_FIRST = new C05334();
    ...
    static final FileFilter SESSION_DIRECTORY_FILTER = new C05323();
    static final String SESSION_EVENT_MISSING_BINARY_IMGS_TAG = "SessionMissingBinaryImages";
    static final String SESSION_FATAL_TAG = "SessionCrash";
    static final FilenameFilter SESSION_FILE_FILTER = new C05312();
    ...
    static final Comparator<File> SMALLEST_FILE_NAME_FIRST = new C05345();
    ...
    static class C05323 implements FileFilter {
        C05323() {
        }
    ...
    static class C05334 implements Comparator<File> {
        C05334() {
        }
    ...
    static class C05345 implements Comparator<File> {
        C05345() {
        }
    ...
    class C05356 implements CrashListener {
        C05356() {
        }
    ...
    private static final class PrivacyDialogCheck implements SendCheck {
        ...
        class C05391 implements AlwaysSendCallback {
            C05391() {
            }
        ...
        public boolean canSendReports() {
            ...
            final CrashPromptDialog dialog = CrashPromptDialog.create(activity, this.promptData, new C05391());
    ...
    void enableExceptionHandling(UncaughtExceptionHandler defaultHandler) {
        openSession();
        this.crashHandler = new CrashlyticsUncaughtExceptionHandler(new C05356(), defaultHandler);
    ...
    private void writeBeginSession(String sessionId, Date startedAt) throws Exception {
        ...
        writeFile(sessionId, "BeginSession.json", new FileOutputStreamWriteAction() {
            ...
            class C05261 extends HashMap<String, Object> {
                C05261() {
                    put("session_id", str);
            ...
            public void writeTo(FileOutputStream arg) throws Exception {
                arg.write(new JSONObject(new C05261()).toString().getBytes());
            }
        });
    }
    ...
    private void writeSessionApp(String sessionId) throws Exception {
        ...
        writeFile(sessionId, "SessionApp.json", new FileOutputStreamWriteAction() {
            ...
            class C05281 extends HashMap<String, Object> {
                C05281() {
            ...
            public void writeTo(FileOutputStream arg) throws Exception {
                arg.write(new JSONObject(new C05281()).toString().getBytes());
            }
        });
    }
    ...
    private void writeSessionOS(String sessionId) throws Exception {
        ...
        writeFile(sessionId, "SessionOS.json", new FileOutputStreamWriteAction() {
            ...
            class C05291 extends HashMap<String, Object> {
                C05291() {
            ...
            public void writeTo(FileOutputStream arg) throws Exception {
                arg.write(new JSONObject(new C05291()).toString().getBytes());
            }
        });
    }
    ...
    private void writeSessionDevice(String sessionId) throws Exception {
        ...
        writeFile(sessionId, "SessionDevice.json", new FileOutputStreamWriteAction() {
            ...
            class C05301 extends HashMap<String, Object> {
                C05301() {
            ...
            public void writeTo(FileOutputStream arg) throws Exception {
                arg.write(new JSONObject(new C05301()).toString().getBytes());
            }
        });
    }
