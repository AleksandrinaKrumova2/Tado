...
public class CrashlyticsCore extends Kit<Void> {
    ...
    class C05411 extends PriorityCallable<Void> {
        C05411() {
        }
    ...
    class C05422 implements Callable<Void> {
        C05422() {
        }
    ...
    class C05433 implements Callable<Boolean> {
        C05433() {
        }
    ...
    class C05444 implements Callable<Boolean> {
        C05444() {
        }
    ...
    private void finishInitSynchronously() {
        PriorityCallable<Void> callable = new C05411();
    ...
    void markInitializationStarted() {
        this.backgroundWorker.submitAndWait(new C05422());
    }

    void markInitializationComplete() {
        this.backgroundWorker.submit(new C05433());
    }

    boolean didPreviousInitializationFail() {
        return ((Boolean) this.backgroundWorker.submitAndWait(new C05444())).booleanValue();
    }
