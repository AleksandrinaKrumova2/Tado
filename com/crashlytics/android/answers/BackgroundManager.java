...
class BackgroundManager {
    ...
    public void onActivityPaused() {
        if (this.flushOnBackground && !this.inBackground) {
            ...
            try {
                this.backgroundFutureRef.compareAndSet(null, this.executorService.schedule(new C05111(), Constants.CHECK_FOR_SERVER_CONNECTION_TIMEOUT, TimeUnit.MILLISECONDS));
