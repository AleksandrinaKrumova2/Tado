...
class AnswersEventsHandler implements EventsStorageListener {
    ...
    class C05084 implements Runnable {
        C05084() {
        }
    ...
    class C05095 implements Runnable {
        C05095() {
        }
    ...
    public void disable() {
        executeAsync(new C05062());
    }

    public void onRollOver(String rolledOverFile) {
        executeAsync(new C05073());
    }

    public void enable() {
        executeAsync(new C05084());
    }

    public void flushEvents() {
        executeAsync(new C05095());
    }
