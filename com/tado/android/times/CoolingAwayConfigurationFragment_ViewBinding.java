...
public class CoolingAwayConfigurationFragment_ViewBinding<T extends CoolingAwayConfigurationFragment> implements Unbinder {
    protected T target;

    @UiThread
    public CoolingAwayConfigurationFragment_ViewBinding(T target, View source) {
        this.target = target;
