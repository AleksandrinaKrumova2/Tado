...
public class AcMinOnOffTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle((int) C0676R.string.settings_zoneSettings_airConditioning_minimumOnOffTime_title);
        ...
        this.fragment = AcMinOnOffTimePreferenceFragment.getInstance(this.zoneId, this.driverDisc, this.minOnOffTimeInSeconds, this.hysteresis);
        getFragmentManager().beginTransaction().replace(16908290, this.fragment, AcMinOnOffTimePreferenceFragment.class.getCanonicalName()).commit();
    }
