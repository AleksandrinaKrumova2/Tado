...
public class Bus {
    ...
    class C06551 extends ThreadLocal<ConcurrentLinkedQueue<EventWithHandler>> {
        C06551() {
        }
    ...
    class C06562 extends ThreadLocal<Boolean> {
        C06562() {
        }
    ...
    Bus(ThreadEnforcer enforcer, String identifier, HandlerFinder handlerFinder) {
        ...
        this.eventsToDispatch = new C06551();
        this.isDispatching = new C06562();
