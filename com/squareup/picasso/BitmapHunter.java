...
class BitmapHunter implements Runnable {
    ...
    private static final RequestHandler ERRORING_HANDLER = new C06612();
    private static final ThreadLocal<StringBuilder> NAME_BUILDER = new C06601();
    ...
    static class C06601 extends ThreadLocal<StringBuilder> {
        C06601() {
        }
    ...
    static class C06612 extends RequestHandler {
        C06612() {
        }
