    ...
    private static synchronized boolean shouldReadKeysAsStrings() {
        ...
        synchronized (GooglePlayCallbackExtractor.class) {
            if (shouldReadKeysAsStringsCached == null) {
                String expectedKey = OnboardingPageFragment.FEATURE_KEY;
                Bundle testBundle = new Bundle();
                testBundle.putString(OnboardingPageFragment.FEATURE_KEY, Param.VALUE);
                ...
                try {
                    ...
                    checkCondition(z);
                    shouldReadKeysAsStringsCached = Boolean.valueOf(OnboardingPageFragment.FEATURE_KEY.equals(testParcel.readString()));
                    testParcel.recycle();
