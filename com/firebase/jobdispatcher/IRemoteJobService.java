...
public interface IRemoteJobService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoteJobService {
        ...
        public static IRemoteJobService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IRemoteJobService)) {
                return new Proxy(obj);
            }
            return (IRemoteJobService) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    start(_arg0, com.firebase.jobdispatcher.IJobCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
