...
public abstract class EventListener {
    public static final EventListener NONE = new C13681();

    class C13681 extends EventListener {
        C13681() {
        }
    }
    ...
    class C13692 implements Factory {
        final /* synthetic */ EventListener val$listener;

        C13692(EventListener eventListener) {
    ...
    public void dnsEnd(Call call, String domainName, @Nullable List<InetAddress> list) {
    }
