...
public final class RealConnection extends Listener implements Connection {
    ...
    L_0x0057:
        ...
        throw r2;
    L_0x007d:
        r2 = r13.route;	 Catch:{ IOException -> 0x00d3 }
        r2 = r2.requiresTunnel();	 Catch:{ IOException -> 0x00d3 }
    ...
    L_0x0085:
        ...
        r6 = r18;
        r7 = r19;
        r2.connectTunnel(r3, r4, r5, r6, r7);	 Catch:{ IOException -> 0x00d3 }
        r2 = r13.rawSocket;	 Catch:{ IOException -> 0x00d3 }
    ...
    L_0x00af:
        r0 = r18;
        r1 = r19;
        r13.connectSocket(r14, r15, r0, r1);	 Catch:{ IOException -> 0x00d3 }
    L_0x00b6:
        r0 = r18;
        r1 = r19;
        r13.establishProtocol(r8, r0, r1);	 Catch:{ IOException -> 0x00d3 }
        r2 = r13.route;	 Catch:{ IOException -> 0x00d3 }
        r2 = r2.socketAddress();	 Catch:{ IOException -> 0x00d3 }
        r3 = r13.route;	 Catch:{ IOException -> 0x00d3 }
        r3 = r3.proxy();	 Catch:{ IOException -> 0x00d3 }
        r4 = r13.protocol;	 Catch:{ IOException -> 0x00d3 }
        r0 = r19;
        r1 = r18;
        r0.connectEnd(r1, r2, r3, r4);	 Catch:{ IOException -> 0x00d3 }
        goto L_0x0095;
    L_0x00d3:
        r7 = move-exception;
        r2 = r13.socket;
    ...
    L_0x011f:
        ...
        monitor-enter(r3);
        r2 = r13.http2Connection;	 Catch:{ all -> 0x012c }
        r2 = r2.maxConcurrentStreams();	 Catch:{ all -> 0x012c }
        r13.allocationLimit = r2;	 Catch:{ all -> 0x012c }
        monitor-exit(r3);	 Catch:{ all -> 0x012c }
    L_0x012b:
        return;
    L_0x012c:
        r2 = move-exception;
