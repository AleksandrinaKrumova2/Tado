...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x000d in list [B:11:0x001f]
...
*/
        ...
        r1 = 0;
    L_0x0001:
        r5.readTheList();	 Catch:{ InterruptedIOException -> 0x000e, IOException -> 0x0011, all -> 0x0027 }
    ...
    L_0x0011:
        r0 = move-exception;
        r2 = okhttp3.internal.platform.Platform.get();	 Catch:{ InterruptedIOException -> 0x000e, IOException -> 0x0011, all -> 0x0027 }
        r3 = 5;	 Catch:{ InterruptedIOException -> 0x000e, IOException -> 0x0011, all -> 0x0027 }
        r4 = "Failed to read public suffix list";	 Catch:{ InterruptedIOException -> 0x000e, IOException -> 0x0011, all -> 0x0027 }
        r2.log(r3, r4, r0);	 Catch:{ InterruptedIOException -> 0x000e, IOException -> 0x0011, all -> 0x0027 }
        if (r1 == 0) goto L_0x000d;
    L_0x001f:
        r2 = java.lang.Thread.currentThread();
        r2.interrupt();
