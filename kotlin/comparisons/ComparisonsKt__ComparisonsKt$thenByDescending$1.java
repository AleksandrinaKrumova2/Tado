...
public final class ComparisonsKt__ComparisonsKt$thenByDescending$1<T> implements Comparator<T> {
    ...
    public final int compare(T a, T b) {
        ...
        return previousCompare != 0 ? previousCompare : ComparisonsKt__ComparisonsKt.compareValues((Comparable) this.$selector.invoke(b), (Comparable) this.$selector.invoke(a));
    }
}
