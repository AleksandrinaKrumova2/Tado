...
class ComparisonsKt__ComparisonsKt {
    public static final <T> int compareValuesBy(T a, T b, @NotNull Function1<? super T, ? extends Comparable<?>>... selectors) {
        ...
        if ((((Object[]) selectors).length > 0 ? 1 : null) != null) {
    ...
    private static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(T a, T b, Function1<? super T, ? extends Comparable<?>>[] selectors) {
        for (Function1 fn : selectors) {
            int diff = compareValues((Comparable) fn.invoke(a), (Comparable) fn.invoke(b));
            if (diff != 0) {
                return diff;
            }
        }
    ...
    private static final <T> Comparator<T> thenBy(@NotNull Comparator<T> $receiver, Function1<? super T, ? extends Comparable<?>> selector) {
        return new ComparisonsKt__ComparisonsKt$thenBy$1($receiver, selector);
    }
    ...
    private static final <T, K> Comparator<T> thenBy(@NotNull Comparator<T> $receiver, Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        return new ComparisonsKt__ComparisonsKt$thenBy$2($receiver, comparator, selector);
    }
    ...
    private static final <T> Comparator<T> thenByDescending(@NotNull Comparator<T> $receiver, Function1<? super T, ? extends Comparable<?>> selector) {
        return new ComparisonsKt__ComparisonsKt$thenByDescending$1($receiver, selector);
    }
    ...
    private static final <T, K> Comparator<T> thenByDescending(@NotNull Comparator<T> $receiver, Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        return new ComparisonsKt__ComparisonsKt$thenByDescending$2($receiver, comparator, selector);
    }
    ...
    private static final <T> Comparator<T> thenComparator(@NotNull Comparator<T> $receiver, Function2<? super T, ? super T, Integer> comparison) {
        return new ComparisonsKt__ComparisonsKt$thenComparator$1($receiver, comparison);
    }
    ...
    public static final <T> Comparator<T> reversed(@NotNull Comparator<T> $receiver) {
        ...
        if (Intrinsics.areEqual($receiver, NaturalOrderComparator.INSTANCE)) {
            ...
            throw new TypeCastException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
        } else if (!Intrinsics.areEqual($receiver, ReverseOrderComparator.INSTANCE)) {
