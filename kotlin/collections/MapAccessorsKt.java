...
public final class MapAccessorsKt {
    ...
    private static final <V, V1 extends V> V1 getValue(@NotNull Map<? super String, ? extends V> $receiver, Object thisRef, KProperty<?> property) {
        ...
        return MapsKt__MapWithDefaultKt.getOrImplicitDefaultNullable($receiver, property.getName());
    }
    ...
    private static final <V> V getVarContravariant(@NotNull Map<? super String, ? super V> $receiver, Object thisRef, KProperty<?> property) {
        return MapsKt__MapWithDefaultKt.getOrImplicitDefaultNullable($receiver, property.getName());
    }
