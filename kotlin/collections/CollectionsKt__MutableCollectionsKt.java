...
*/
    ...
    @InlineOnly
    private static final <T> void fill(@NotNull List<T> $receiver, T value) {
        Collections.fill($receiver, value);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final <T> void shuffle(@NotNull List<T> $receiver) {
        Collections.shuffle($receiver);
    }

    @SinceKotlin(version = "1.2")
    @InlineOnly
    private static final <T> void shuffle(@NotNull List<T> $receiver, Random random) {
    ...
    public static final <T> List<T> shuffled(@NotNull Iterable<? extends T> $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        List $receiver2 = CollectionsKt___CollectionsKt.toMutableList((Iterable) $receiver);
