...
public final class MathKt {
    public static final double f420E = 2.718281828459045d;
    ...
    private static final double upper_taylor_2_bound = (((double) 1) / taylor_2_bound);
    private static final double upper_taylor_n_bound = (((double) 1) / taylor_n_bound);
    ...
    public static final int roundToInt(double $receiver) {
        ...
        } else if ($receiver > ((double) 2147483647)) {
            return Integer.MAX_VALUE;
        } else {
            if ($receiver < ((double) -2147483648)) {
