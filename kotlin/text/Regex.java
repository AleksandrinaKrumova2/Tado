...
public final class Regex implements Serializable {
    ...
    private static final class Serialized implements Serializable {
        ...
        @Metadata(bv = {1, 0, 2}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lkotlin/text/Regex$Serialized$Companion;", "", "()V", "serialVersionUID", "", "kotlin-stdlib"}, k = 1, mv = {1, 1, 9})
        /* compiled from: Regex.kt */
        public static final class Companion {
            private Companion() {
            }
    ...
    public final Set<RegexOption> getOptions() {
        ...
        CollectionsKt__MutableCollectionsKt.retainAll((Iterable) $receiver$iv, (Function1) new Regex$fromInt$$inlined$apply$lambda$1(value$iv));
        set = Collections.unmodifiableSet($receiver$iv);
    ...
    public final String replace(@NotNull CharSequence input, @NotNull String replacement) {
        Intrinsics.checkParameterIsNotNull(input, "input");
        Intrinsics.checkParameterIsNotNull(replacement, SrtHvacInstallationFragment.KEY_IS_REPLACEMENT);
    ...
    public final List<String> split(@NotNull CharSequence input, int limit) {
        ...
        Object split = pattern.split(input, limit);
