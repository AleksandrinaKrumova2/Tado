...
public final class C1305x1c00f072 implements Sequence<T> {
    final /* synthetic */ Function2 $builderAction$inlined;

    public C1305x1c00f072(Function2 function2) {
        this.$builderAction$inlined = function2;
    }

    @NotNull
    public Iterator<T> iterator() {
        return SequenceBuilderKt__SequenceBuilderKt.buildIterator(this.$builderAction$inlined);
    }
}
