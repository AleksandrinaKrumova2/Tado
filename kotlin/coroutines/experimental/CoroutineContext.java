...
public interface CoroutineContext {
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            @NotNull
            public static CoroutineContext plus(@NotNull Element $this, CoroutineContext context) {
                Intrinsics.checkParameterIsNotNull(context, "context");
                return DefaultImpls.plus($this, context);
            }

            @Nullable
            public static <E extends Element> E get(@NotNull Element $this, Key<E> key) {
            ...
            public static <R> R fold(Element $this, @NotNull R initial, Function2<? super R, ? super Element, ? extends R> operation) {
                Intrinsics.checkParameterIsNotNull(operation, "operation");
                return operation.invoke(initial, $this);
            }

            @NotNull
            public static CoroutineContext minusKey(@NotNull Element $this, Key<?> key) {
                Intrinsics.checkParameterIsNotNull(key, OnboardingPageFragment.FEATURE_KEY);
    ...
    public static final class DefaultImpls {
        @NotNull
        public static CoroutineContext plus(@NotNull CoroutineContext $this, CoroutineContext context) {
            Intrinsics.checkParameterIsNotNull(context, "context");
