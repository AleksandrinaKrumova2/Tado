...
*/
    ...
    L_0x0004:
        ...
        r0 = 0;
        r0 = r3.doResume(r4, r0);	 Catch:{ Throwable -> 0x001e }
        r2 = kotlin.coroutines.experimental.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED();	 Catch:{ Throwable -> 0x001e }
        if (r0 == r2) goto L_0x0022;	 Catch:{ Throwable -> 0x001e }
        if (r1 != 0) goto L_0x0023;	 Catch:{ Throwable -> 0x001e }
        r0 = new kotlin.TypeCastException;	 Catch:{ Throwable -> 0x001e }
        r2 = "null cannot be cast to non-null type kotlin.coroutines.experimental.Continuation<kotlin.Any?>";	 Catch:{ Throwable -> 0x001e }
    ...
    L_0x001e:
        ...
        return;
        r1.resume(r0);	 Catch:{ Throwable -> 0x001e }
        goto L_0x0022;
        */
...
*/
    ...
    L_0x000a:
        kotlin.jvm.internal.Intrinsics.throwNpe();
        r0 = 0;
        r0 = r3.doResume(r0, r4);	 Catch:{ Throwable -> 0x0024 }
        r2 = kotlin.coroutines.experimental.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED();	 Catch:{ Throwable -> 0x0024 }
        if (r0 == r2) goto L_0x0028;	 Catch:{ Throwable -> 0x0024 }
        if (r1 != 0) goto L_0x0029;	 Catch:{ Throwable -> 0x0024 }
        r0 = new kotlin.TypeCastException;	 Catch:{ Throwable -> 0x0024 }
        r2 = "null cannot be cast to non-null type kotlin.coroutines.experimental.Continuation<kotlin.Any?>";	 Catch:{ Throwable -> 0x0024 }
        r0.<init>(r2);	 Catch:{ Throwable -> 0x0024 }
        throw r0;	 Catch:{ Throwable -> 0x0024 }
    L_0x0024:
        r0 = move-exception;
        r1.resumeWithException(r0);
        return;
        r1.resume(r0);	 Catch:{ Throwable -> 0x0024 }
        goto L_0x0028;
        */
