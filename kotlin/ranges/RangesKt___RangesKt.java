...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(double $receiver) {
        return ($receiver < ((double) -128) || $receiver > ((double) 127)) ? null : Byte.valueOf((byte) ((int) $receiver));
    }

    @Nullable
    public static final Byte toByteExactOrNull(float $receiver) {
        return ($receiver < ((float) -128) || $receiver > ((float) 127)) ? null : Byte.valueOf((byte) ((int) $receiver));
    }
    ...
    public static final Long toLongExactOrNull(double $receiver) {
        return ($receiver < ((double) Long.MIN_VALUE) || $receiver > ((double) LongCompanionObject.MAX_VALUE)) ? null : Long.valueOf((long) $receiver);
    }

    @Nullable
    public static final Long toLongExactOrNull(float $receiver) {
        return ($receiver < ((float) Long.MIN_VALUE) || $receiver > ((float) LongCompanionObject.MAX_VALUE)) ? null : Long.valueOf((long) $receiver);
    }
    ...
    public static final Short toShortExactOrNull(double $receiver) {
        return ($receiver < ((double) -32768) || $receiver > ((double) 32767)) ? null : Short.valueOf((short) ((int) $receiver));
    }

    @Nullable
    public static final Short toShortExactOrNull(float $receiver) {
        return ($receiver < ((float) -32768) || $receiver > ((float) 32767)) ? null : Short.valueOf((short) ((int) $receiver));
    }
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(@NotNull T $receiver, @NotNull ClosedFloatingPointRange<T> range) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(range, AcSetupSettingsActivity.KEY_MIN_ON_OFF_TIME);
        if (range.isEmpty()) {
