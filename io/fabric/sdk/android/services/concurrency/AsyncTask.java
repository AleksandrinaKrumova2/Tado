...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory threadFactory = new C13411();
    ...
    private final WorkerRunnable<Params, Result> worker = new C13422();

    static class C13411 implements ThreadFactory {
    ...
    class C13422 extends WorkerRunnable<Params, Result> {
        C13422() {
            super();
        }
