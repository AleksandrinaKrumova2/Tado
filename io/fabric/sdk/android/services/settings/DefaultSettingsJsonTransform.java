...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    private JSONObject toAppJson(AppSettingsData appData) throws JSONException {
        JSONObject json = new JSONObject().put(SettingsJsonConstants.APP_IDENTIFIER_KEY, appData.identifier).put("status", appData.status).put("url", appData.url).put(SettingsJsonConstants.APP_REPORTS_URL_KEY, appData.reportsUrl).put(SettingsJsonConstants.APP_NDK_REPORTS_URL_KEY, appData.ndkReportsUrl).put(SettingsJsonConstants.APP_UPDATE_REQUIRED_KEY, appData.updateRequired);
    ...
    private JSONObject toPromptJson(PromptSettingsData data) throws JSONException {
        return new JSONObject().put("title", data.title).put(SettingsJsonConstants.PROMPT_MESSAGE_KEY, data.message).put(SettingsJsonConstants.PROMPT_SEND_BUTTON_TITLE_KEY, data.sendButtonTitle).put(SettingsJsonConstants.PROMPT_SHOW_CANCEL_BUTTON_KEY, data.showCancelButton).put(SettingsJsonConstants.PROMPT_CANCEL_BUTTON_TITLE_KEY, data.cancelButtonTitle).put(SettingsJsonConstants.PROMPT_SHOW_ALWAYS_SEND_BUTTON_KEY, data.showAlwaysSendButton).put(SettingsJsonConstants.PROMPT_ALWAYS_SEND_BUTTON_TITLE_KEY, data.alwaysSendButtonTitle);
    }
}
