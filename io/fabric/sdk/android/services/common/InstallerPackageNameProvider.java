...
public class InstallerPackageNameProvider {
    ...
    private final ValueLoader<String> installerPackageNameLoader = new C13381();

    class C13381 implements ValueLoader<String> {
        C13381() {
        }
    ...
    public String getInstallerPackageName(Context appContext) {
        try {
            ...
            Fabric.getLogger().mo3691e(Fabric.TAG, "Failed to determine installer package name", e);
            return null;
        }
    }
}
