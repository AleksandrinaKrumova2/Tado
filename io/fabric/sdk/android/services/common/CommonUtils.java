...
*/
    ...
    L_0x0020:
        ...
        r4.e(r5, r6, r0);	 Catch:{ Exception -> 0x0020, all -> 0x0036 }
    ...
    L_0x003e:
        ...
        r7.e(r8, r9, r2);	 Catch:{ all -> 0x0063 }
        r7 = "Failed to close system file reader.";
        closeOrLog(r0, r7);
        goto L_0x003c;
    L_0x0063:
    ...
    public static Float getBatteryLevel(Context context) {
        ...
        return Float.valueOf(((float) battery.getIntExtra(Param.LEVEL, -1)) / ((float) battery.getIntExtra("scale", -1)));
    }
